 ...
 *
 * To use it, put your font in /assets/font.  You can access them in XML by their filename, minus
 * the extension (e.g. "Roboto-BoldItalic" or "roboto-bolditalic" for Roboto-BoldItalic.ttf).
 *
 * To set custom names for font other than their filenames, call addFont().
 *
 */
public class FontCache {
    ...
    private FontCache(Context context) {
        ...
        try {
            ...
            Log.e(TAG, "Error loading font from assets/font.");
            return;
        }
